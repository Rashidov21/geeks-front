...
const InfoModal = () => {
    const { url, setAct, infoModal, coursesId, setInfoModal, registerModal, setRegisterModal } = useContext(Context);
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                // Если data - это массив, или есть data.data
                if (Array.isArray(data)) {
                    ...
                    console.error('Ошибка: Некорректные данные получены от сервера.', data);
                    setLoader(false);
                }
            } catch (error) {
