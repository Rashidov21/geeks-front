...
const Header = () => {
    ...
    return (
        <header className={styles.header}>
            <MyContainer>
                <div
                    className={`${styles.modalOpacity} ${nav || infoModal || registerModal ? styles.actModal : ''}`}
                    onClick={() => {
                        setNav(false);
                        setInfoModal(false);
                ...
                <div className={styles.header__content}>
                    <nav className={styles.header__content__nav}>
                        <div className={styles.header__content__nav__logo}>
                            <div
                                onClick={() => setNav(!nav)}
                            ...
                            <Link onClick={() => setNav(false)} className={styles.resLogo} href="/">
                                <Image src={resLogo} alt="logo" width={50} height={40} />
                            </Link>
                        </div>
                    ...
                    <button onClick={() => setRegisterModal(true)} className={styles.header__content__btn}>
                        O’qishni boshlash
                    </button>
                </div>
            </MyContainer>
